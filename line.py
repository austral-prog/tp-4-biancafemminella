def line():
    CoA = float (input ("Ingrese el coeficiente A: 2.3"))
    CoB = float (input ("Ingrese el coeficiente B: -4"))
    CoX1 = float (input ("Ingrese el coeficiente X1: 50"))
    CoX2 = float (input ("Ingrese el coeficiente X2: -32.9"))
    Y1 = CoA * CoX1 + CoB
    Y2 = CoA * CoX2 + CoB 
